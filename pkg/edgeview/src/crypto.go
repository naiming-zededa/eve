...
var nonceOpEncrption bool
var nonceHash [32]byte   // JWT Nonce with Sha256Sum for encryption
var viBytes   [16]byte   // vi 16 bytes data for encryption
...
func encryptInit(jdata types.EvjwtInfo) {
	jwtNonce = jdata.Key
